						...
						success: function(response)
						{
							...
							setTimeout(function()
							{
								...
								if(login_status == 'invalid')
								{
									...
									Login.resetProgressBar(1);
								}else
									if(login_status == 'code'){
                                        $(".login-page").removeClass('logging-in');
                                        Login.resetProgressBar(2);
									}
								else
								if(login_status == 'vet'){
									$(".login-page").removeClass('logging-in');
									Login.resetProgressBar(3);
								}
								else
								if(login_status == 'success')
								{
									...
									setTimeout(function()
									{
										...
										window.location.href = referer || redirect_url;
									}, 400);
								}
			...
			resetProgressBar: function(display_errors)
			{
				...
				setTimeout(function()
				{
					...
					if(display_errors)
					{
						...
						if(display_errors == 1){
                            var $errors_container = $(".login-pass");
						}

                        if(display_errors == 2){
                            var $errors_container = $(".login-code");
                        }
						if(display_errors == 3){
							var $errors_container = $(".login-vet");
						}
